...
implementation
  ...
  function mongo_env_sock_init() : Integer;  cdecl; external;
  function mongo_create() : Pointer; cdecl; external;
  procedure mongo_dispose(c : Pointer); cdecl; external;
  function mongo_client(c : Pointer; host : PAnsiChar; port : Integer) : Integer;
    cdecl; external;
  procedure mongo_destroy(c : Pointer); cdecl; external;
  procedure mongo_replica_set_init(c : Pointer; name : PAnsiChar); cdecl; external;
  procedure mongo_replica_set_add_seed(c : Pointer; host : PAnsiChar; port : Integer);
    cdecl; external;
  function mongo_replica_set_client(c : Pointer) : Integer; cdecl; external;
  function mongo_is_connected(c : Pointer) : Boolean;  cdecl; external;
  function mongo_get_err(c : Pointer) : Integer; cdecl; external;
  function mongo_set_op_timeout(c : Pointer; millis : Integer) : Integer;
    cdecl; external;
  function mongo_get_op_timeout(c : Pointer) : Integer; cdecl; external;
  function mongo_get_primary(c : Pointer) : PAnsiChar; cdecl; external;
  function mongo_check_connection(c : Pointer) : Integer; cdecl; external;
  procedure mongo_disconnect(c : Pointer); cdecl; external;
  function mongo_reconnect(c : Pointer) : Integer; cdecl; external;
  function mongo_cmd_ismaster(c : Pointer; b : Pointer) : Boolean;
    cdecl; external;
  function mongo_get_socket(c : Pointer) : Integer; cdecl; external;
  function mongo_get_host_count(c : Pointer) : Integer; cdecl; external;
  function mongo_get_host(c : Pointer; i : Integer) : PAnsiChar; cdecl; external;
  ...
  function mongo_cursor_create() : Pointer;  cdecl; external;
  procedure mongo_cursor_dispose(cursor : Pointer); cdecl; external;
  procedure mongo_cursor_destroy(cursor : Pointer); cdecl; external;
  function mongo_find(c : Pointer; ns : PAnsiChar; query : Pointer; fields : Pointer;
                      limit, skip, options : Integer) : Pointer; cdecl; external;
  function mongo_cursor_next(cursor : Pointer) : Integer; cdecl; external;
  function mongo_cursor_bson(cursor : Pointer) : Pointer; cdecl; external;
  function mongo_cmd_drop_collection(c : Pointer; db : PAnsiChar; collection : PAnsiChar; result : Pointer) : Integer;
    cdecl; external;
  function mongo_cmd_drop_db(c : Pointer; db : PAnsiChar) : Integer; cdecl; external;
  ...
  function mongo_cmd_get_prev_error(c : Pointer; db : PAnsiChar; res: Pointer) : Integer;
    cdecl; external;
  function mongo_get_server_err(c : Pointer) : Integer; cdecl; external;
  function mongo_get_server_err_string(c : Pointer) : PAnsiChar; cdecl; external;
